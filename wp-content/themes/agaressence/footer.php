...
?>
    ...
    <footer class="footer pt-5">
        ...
        <div class="container-xxl">
          <div class="row justify-content-center"> 
            ...
            <div class="col-12 col-md-6 border-start-c1 px-lg-4">
              <div class="row gx-3 gx-sm-3 gx-xl-4 gy-4 gy-sm-4 gy-md-0">
                <div class="col-6 col-sm">
                  <div class="fw-smi-bold fs-16 color-e09654 mb-4">Legal Protection</div>
                  <ul class="list-unstyled">
                    <li><a class="text-decoration-none mb-3 color-ebebeb link-hover-1 d-block" href="<?php bloginfo('url'); ?>/" title="Privacy Policy">Privacy Policy</a></li>
                    <li><a class="text-decoration-none mb-3 color-ebebeb link-hover-1 d-block" href="<?php bloginfo('url'); ?>/" title="Terms and Conditions">Terms and Conditions</a></li>
                    <li><a class="text-decoration-none mb-3 color-ebebeb link-hover-1 d-block" href="<?php bloginfo('url'); ?>/" title="Terms of Sales">Terms of Sales</a></li>
                    <li><a class="text-decoration-none mb-3 color-ebebeb link-hover-1 d-block" href="<?php bloginfo('url'); ?>/" title="Legal Disclaimers">Legal Disclaimers</a></li>
                  </ul>
                </div>
                <div class="col-6 col-sm">
                  <div class="fw-smi-bold fs-16 color-e09654 text-opacity-87 mb-4">Customer Service</div>
                  <ul class="list-unstyled">
                    <li><a class="text-decoration-none mb-3 color-ebebeb link-hover-1 d-block" href="<?php bloginfo('url'); ?>/contact-us" title="Contact us">Contact us</a></li>
                    <li><a class="text-decoration-none mb-3 color-ebebeb link-hover-1 d-block" href="" title="About us">About us</a></li>
                    <li><a class="text-decoration-none mb-3 color-ebebeb link-hover-1 d-block" href="/faqs" title="FAQs">FAQs</a></li>                    
                    <li><a class="text-decoration-none mb-3 color-ebebeb link-hover-1 d-block" href="" title="Site map">Site map</a></li>
                    <li><a class="text-decoration-none mb-3 color-ebebeb link-hover-1 d-block" href="" title="Blogs">Blogs</a></li>
                  </ul>
                </div>
                <div class="col-6 col-sm">
                  <div class="fw-smi-bold fs-16 color-e09654 text-opacity-87 mb-3">Shop</div>
                  <ul class="list-unstyled">
                    <li><a class="text-decoration-none mb-3 color-ebebeb link-hover-1 d-block" href="<?php bloginfo('url'); ?>/" title="Product 1">Product 1</a></li>
                    <li><a class="text-decoration-none mb-3 color-ebebeb link-hover-1 d-block" href="" title="">Product 2</a></li>
                    <li><a class="text-decoration-none mb-3 color-ebebeb link-hover-1 d-block" href="" title="Training">Training</a></li>
                    <li><a class="text-decoration-none mb-3 color-ebebeb link-hover-1 d-block" href="" title="Blogs">Blogs</a></li>
                  </ul>
                </div>
              </div>
            ...
            <div class="col-12 col-md-3 border-start-c1 ps-lg-4">
              <div class="fw-smi-bold fs-16 color-e09654 text-opacity-87 mb-3">Follow The Agaressence</div>
              ...
              <div class="fw-smi-bold fs-16 color-e09654 text-opacity-87 mb-3">Support Payment</div>              
      ...
      <div class="container-xxl">
        ...
        <div class="text-center pb-4">Copyright © 2022 Agaressence. All Rights Reserved.</div>
      </div>
    </footer>
