	...
	<div class="row">
		<div class="col-12 col-sm-11 col-md-10 col-lg-9">
			<div class="d-flex">
				...
				<input type="search" id="<?php echo esc_attr( $twentytwenty_unique_id ); ?>" class="search-field form-control py-2 rounded-0" placeholder="<?php echo esc_attr_x( 'Search &hellip;', 'placeholder', 'twentytwenty' ); ?>" value="<?php echo get_search_query(); ?>" name="s" />
				<input type="submit" class="search-submit btn btn-submit rounded-0 px-3 px-sm-4 py-2 ms-1 ms-lg-3" value="<?php echo esc_attr_x( 'Search', 'submit button', 'twentytwenty' ); ?>" />
			</div>
		</div>
	</div>
</form>
