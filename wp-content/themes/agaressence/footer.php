          ...
          <div class="row justify-content-center"> 
            <div class="col-12 col-md-3 mb-4 mb-md-0 pe-lg-4">
              ...
              <div class="d-flex mb-3 mb-lg-4 link-hover-1">
                ...
                <a class="color-959595 text-decoration-none ms-2" href="tel:0333 050 8269" title="0333 050 8269">0333 050 8269</a>
              </div>
            </div> 
            <div class="col-12 col-md-6 border-start-c1 px-lg-4">
              <div class="row gx-3 gx-sm-3 gx-xl-4 gy-4 gy-sm-4 gy-md-0">
                <div class="col-6 col-sm">
                  <div class="fw-smi-bold fs-16 text-white mb-3 mb-lg-4">Legal Protection</div>
                  <ul class="list-unstyled mb-0">
                    <li><a class="text-decoration-none mb-2 mb-lg-3 color-959595 link-hover-1 d-block" href="<?php bloginfo('url'); ?>/privacy-policy" title="Privacy Policy">Privacy Policy</a></li>
                    <li><a class="text-decoration-none mb-2 mb-lg-3 color-959595 link-hover-1 d-block" href="<?php bloginfo('url'); ?>/terms-and-conditions" title="Terms and Conditions">Terms and Conditions</a></li>
                    <li><a class="text-decoration-none mb-2 mb-lg-3 color-959595 link-hover-1 d-block" href="<?php bloginfo('url'); ?>/" title="Terms of Sales">Terms of Sales</a></li>
                    <li><a class="text-decoration-none mb-2 mb-lg-3 color-959595 link-hover-1 d-block" href="<?php bloginfo('url'); ?>/" title="Legal Disclaimers">Legal Disclaimers</a></li>
                  </ul>
                </div>
                <div class="col-6 col-sm">
                  <div class="fw-smi-bold fs-16 text-white mb-3 mb-lg-4">Customer Service</div>
                  <ul class="list-unstyled mb-0">
                    <li><a class="text-decoration-none mb-2 mb-lg-3 color-959595 link-hover-1 d-block" href="<?php bloginfo('url'); ?>/contact-us" title="Contact us">Contact us</a></li>
                    <li><a class="text-decoration-none mb-2 mb-lg-3 color-959595 link-hover-1 d-block" href="<?php bloginfo('url'); ?>/about-us" title="About us">About us</a></li>
                    <li><a class="text-decoration-none mb-2 mb-lg-3 color-959595 link-hover-1 d-block" href="<?php bloginfo('url'); ?>/faqs" title="FAQs">FAQs</a></li>                    
                    <li><a class="text-decoration-none mb-2 mb-lg-3 color-959595 link-hover-1 d-block" href="" title="Site map">Site map</a></li>
                    <li><a class="text-decoration-none mb-2 mb-lg-3 color-959595 link-hover-1 d-block" href="<?php bloginfo('url'); ?>/blogs" title="Blogs">Blogs</a></li>
                  </ul>
                </div>
                <div class="col-6 col-sm">
                  <div class="fw-smi-bold fs-16 text-white mb-3 mb-lg-4">Shop</div>
                  <?php
                    $taxonomy = 'product_cat';
                    $args = array('taxonomy' => $taxonomy,'hide_empty' => 1,'parent'   => 0,);
                    ...
                    if ( $all_categories && !is_wp_error( $all_categories ) ) {   
                      ...
                      foreach ($all_categories as $cat) {
                        ...
                        echo '<li><a class="text-decoration-none mb-2 mb-lg-3 color-959595 link-hover-1 d-block" href="'. get_term_link($cat->slug, $taxonomy) .'" title="'.$cat->name.'">'.$cat->name.'</a></li>';
                      }
                      echo '</ul>';
                    }
                  ?>	
